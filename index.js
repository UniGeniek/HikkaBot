...
var token = token_obj["NzAyNTk4NzAzNTAzOTAwNzM1.XrLNzw.8CQH60ckuLqGHABcAib3iOrPR4A"];
...
var owner_discord_id = owner_id_obj["430788705087782929"];
var report_channel = require("report_channel.json");
var channel_id = report_channel["705863522453815345"];
...
client
  .on("reconnecting", () => {
    console.warn("Hikka is reconnecting...");
  })
  .on("disconnect", () => {
    console.warn("Warning! Hikka has disconnected!");
  });
